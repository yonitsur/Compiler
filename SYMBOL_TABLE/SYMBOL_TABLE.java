...
public class SYMBOL_TABLE
{
	...
	public void increaseScopeLocals(){
		SYMBOL_TABLE_ENTRY e = top;
		while (e != null && !e.name.equals("SCOPE-BOUNDARY")) e = e.prevtop;
		e.increaseLocalsCounter();
	}

	public int getScopeLocals(){
		SYMBOL_TABLE_ENTRY e = top;
		while (e != null && !e.name.equals("SCOPE-BOUNDARY")) e = e.prevtop;
		return e.getLocalsCounter();
	}

	public void enter(String name,TYPE t, PARAM_LOCAL paramLocal){
		/*************************************************/
		...
		if (paramLocal == null){
			e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,next,top,top_index++);
		} else {
			if (paramLocal.varType == PARAM_LOCAL.VAR_TYPE.LOCAL){
				increaseScopeLocals();
			}
			e = new SYMBOL_TABLE_ENTRY(name, t, hashValue, next, top, top_index++, paramLocal);
		}
	...
	/**********************************************************************/
	/* Find the inner-most scope element with name and return param local */
	/**********************************************************************/
	public PARAM_LOCAL findParamLocal(String name)
	{
		SYMBOL_TABLE_ENTRY e;
    ...
    // tamir added
    public boolean is_already_in_this_scope(String name)
	{
        // check if the name is in the current scope
        // run over top and stop when you reach Scope boundary
        SYMBOL_TABLE_ENTRY e = top;
    ...
    public SYMBOL_TABLE_ENTRY get_top()
    {
        return top;
    }
